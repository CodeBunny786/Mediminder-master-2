...
import 'package:medicine_reminder/src/ui/newCustomReminder/new_custom_entry.dart';
...
//   }
// }
enum Product { food_Reminder, Gym_Reminder, Sleep_Reminder, Custom_Reminder }
        ...
        return SimpleDialog(
          ...
          children: <Widget>[
            SimpleDialogOption(
              ...
              child: const Text('food_Reminder'),
            ),
            SimpleDialogOption(
              onPressed: () {
                Navigator.push(
                ...
                // Navigator.pop(context, Product.food_Reminder);
              },
              child: const Text('Gym_Reminder'),
            ),
            SimpleDialogOption(
              onPressed: () {
                Navigator.push(
                ...
                // Navigator.pop(context, Product.Gym_Reminder);
              },
              child: const Text('Sleep_Reminder'),
            ),
            SimpleDialogOption(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => NewCustomEntry(),
                  ),
                );

                // Navigator.pop(context, Product.Custom_Reminder);
              },
              child: const Text('Custom_Reminder'),
            ),
            FlatButton(
